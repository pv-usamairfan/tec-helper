        ...
        <div className="rounded-box">
          ...
          <div className="pGrid">
            <div className="block">
              ...
              <p>
                You give us a time which works best for you. That is the reason
                you will nt have any waiting time with us and you can get help
                instantly
              </p>
            </div>
            <div className="block">
              ...
              <p>
                Through intelligent appointment booking system we will find out,
                which problem you are currently facing. Thereby we can preparre
            ...
            <div className="block">
              ...
              <p>
                ...
                your problem. You will receive a notification instantly if your
                appointment is confirmend.
              </p>
            </div>
          </div>
          <div>
